...
public strictfp class RobotPlayer {
    ...
    static int destabilizerCount = 0;
    static int maxCarriersPerArea = 10;
    static MapLocation target;
    static RobotType[] attackPriority = new RobotType[] {RobotType.DESTABILIZER, RobotType.LAUNCHER, RobotType.HEADQUARTERS, RobotType.CARRIER};
    static HashMap<RobotType, Integer> priorityMap = new HashMap<>();
    static int turnOrderIndex = 0;
    static int launcherIndexStart = 3;
    static int launcherIndexEnd = 63;
